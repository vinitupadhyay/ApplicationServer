...
public class LoginRequest 
{
	...
	public LoginRequest(Map<String, Object> param) 
	{
		map = param;
		getMessageLen();
	}
	...
	private void buildCommand()
	{
		...
		linkMap.put("clientId", map.get("clientId"));
		linkMap.put("moduloLen", map.get("moduloLen"));
		linkMap.put("pingTimeOut", map.get("pingTimeOut"));
		linkMap.put("loginMode", map.get("loginMode"));
