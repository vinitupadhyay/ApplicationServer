...
public class FileBlockUploadRequest
{
	private Map<String, Object> map;
	private int messageLen;
	private byte[] message;
	
	public FileBlockUploadRequest(Map<String, Object> param) 
	{
		map = param;
		getMessageLen();
	}
	...
	private void buildCommand()
	{
		...
		linkMap.put("blkOffset", map.get("blkOffset"));
		linkMap.put("blkSize", map.get("blkSize"));
		linkMap.put("blkData", map.get("blkData"));
