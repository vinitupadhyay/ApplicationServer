...
public class CreateWindowResourceRequest
{
	private Map<String, Object> map;
	private int messageLen;
	private byte[] message;
	
	public CreateWindowResourceRequest(Map<String, Object> param) 
	{
		map = param;
		getMessageLen();
	}
	...
	private void buildCommand()
	{
		...
		linkMap.put("allign", map.get("allign"));
		linkMap.put("posx", map.get("posx"));
		linkMap.put("posy", map.get("posy"));
