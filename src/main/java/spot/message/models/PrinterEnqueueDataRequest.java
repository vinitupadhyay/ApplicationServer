...
public class PrinterEnqueueDataRequest
{
	private Map<String, Object> map;
	private int messageLen;
	private byte[] message;
	
	public PrinterEnqueueDataRequest(Map<String, Object> param) 
	{
		map = param;
		getMessageLen();
	}
	...
	private void buildCommand()
	{
		...
		linkMap.put("jobId", map.get("jobId"));
		linkMap.put("seqNo", map.get("seqNo"));
		linkMap.put("txtLen", map.get("txtLen"));
		linkMap.put("text", map.get("text"));
